...
<section class="sf-section">
    <div class="sf-container">
        <div class="sf-auth-card">
            ...
            @endif
            <h1 style="color: var(--color-text-primary); font-size: 18px; text-align: center; margin-bottom: 24px; text-transform: uppercase;">Set New Password</h1>
            @if ($errors->any())
            ...
            <form method="post" action="{{ route('password.update') }}">
                ...
                <div style="margin-bottom: 16px;">
                    ...
                    <input type="email" name="email" value="{{ old('email', $email) }}" class="sf-input" required readonly>
                </div>
                <div style="margin-bottom: 16px;">
                    <label class="sf-label">New Password</label>
                    <input type="password" name="password" class="sf-input" required autofocus>
                </div>
                <div style="margin-bottom: 24px;">
                    <label class="sf-label">Confirm Password</label>
                    <input type="password" name="password_confirmation" class="sf-input" required>
                </div>
                <button type="submit" class="sf-btn-primary">Reset Password</button>
            </form>
